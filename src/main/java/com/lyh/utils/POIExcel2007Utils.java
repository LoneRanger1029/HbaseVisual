 ...
 *  2. 剩余行均为数据行
 */
public class POIExcel2007Utils implements ExcelToHBaseDataFormat{

    public Set<String> columnFamilySet = new HashSet<>();

    public static void main(String[] args) throws IOException, InterruptedException {
        Set<String> res = new POIExcel2007Utils().readTitle("D:\\Desktop\\工作簿1.xlsx");
        for (String s : res) {
            System.out.println(s);
        }
        new POIExcel2007Utils().preview("D:\\Desktop\\工作簿1.xlsx",Integer.MAX_VALUE-2);
    }
